...
type ParaphraseListToolbarProps = {
	searchInput: string;
...
export const ParaphraseListToolbar = memo(function ParaphraseListToolbar({
	searchInput,
	onSearchChange,
	levelFilter,
	topicFilter,
		...
		<div className="flex flex-wrap justify-between items-center gap-3">
			...
			<div className="flex flex-wrap items-center gap-3">
				...
				<Select value={levelFilter} onValueChange={onLevelFilterChange}>
					...
					<SelectContent>
						<SelectItem value={PARAPHRASE_ALL_FILTER}>Tất cả cấp độ</SelectItem>
				...
				<Select value={topicFilter} onValueChange={onTopicFilterChange}>
					...
					<SelectContent>
						<SelectItem value={PARAPHRASE_ALL_FILTER}>Tất cả chủ đề</SelectItem>
